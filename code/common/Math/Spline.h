 ...
 */
inline void solve_tridiagonal_system(std::vector<double>& lower, std::vector<double>& diag, std::vector<double>& upper, std::vector<double>& rhs)
{
...
public:
     ...
     */
    cubic_spline(std::vector<double> const& t, std::vector<double> const& x, boundary_conditions bc = natural)
    {
        make_spline(t, x, bc);
        make_bins();
    }
...
private:
     ...
     */
    void make_spline(std::vector<double> const& knots, std::vector<double> const& values, boundary_conditions bc)
    {
