...
template <uint32_t A, typename R, typename... Args>
...
public:
    ...
    static constexpr uint32_t hash = A;
    ...
    {
        address = hash ? RED4ext::UniversalRelocBase::Resolve(hash) : 0;
    }
...
template<uint32_t A, typename C, typename R, typename... Args>
...
public:
    ...
    static constexpr uintptr_t hash = A;
    ...
    R operator()(C* aContext, Args... aArgs) const
    {
        ...
        auto callable = *reinterpret_cast<Callable*>(vft + RED4ext::UniversalRelocBase::Resolve(hash));
