...
void Support::MinHookProvider::Enqueue(std::function<void()> aFunc)
{
    m_queue.Add(std::move(aFunc));
}

void Support::MinHookProvider::OnGameUpdate(RED4ext::CGameApplication* apApp)
{
    m_queue.Drain();
}
